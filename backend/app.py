...
def new_record_month(random_id):
    create_df(csv_path ='./csv/hospital'+ str(random_id)+ '.csv', json_path='./json/hospital'+ str(random_id)+ '.json', n=30)
    convert_to_json(csv_path ='./csv/hospital'+ str(random_id)+ '.csv', json_path='./json/hospital'+ str(random_id)+ '.json')
    with open('./json/hospital'+ str(random_id)+ '.json', 'r') as jsonfile:
        file_data = json.loads(jsonfile.read())
...
def get_predictions(random_id):
    ...
    column_list = []
    dict = {}
    original_data = pd.read_csv('./csv/hospital'+ str(random_id)+ '.csv', index_col=0)
